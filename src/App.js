...
import './App.css'
import DisplayGame from './components/cases'
import hero from './components/images/DOND.jpg'
...
function App() {
  ...
  const getPlayers = async () => {
    try {
      ...
      const url = `https://api.sleeper.com/projections/nfl/2022/${weekInput}?season_type=regular&position=${typeInput}&order_by=pts_ppr`
